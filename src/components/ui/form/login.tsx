...
export default function LoginForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <InputForm idvalue="email" type="text" onchange={(e) => setEmail(e.target.value)} labelText="email" valueInput={email} />
            <InputForm idvalue="password" type="text" onchange={(e) => setPassword(e.target.value)} labelText="password" valueInput={password} />
