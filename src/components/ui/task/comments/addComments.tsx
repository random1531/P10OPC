...
export default function AddCommentsToTask({ projectId, taskId }: AddCommentsProps) {
        ...
        <>
            {isLoading ? (
                ...
                <div className="flex justify-between h-32">
                    <p>ui</p>
                    <form onSubmit={handleSubmit} className="flex items-end flex-col gap-2.5 justify-between h-full w-11/12 rounded-xl">
